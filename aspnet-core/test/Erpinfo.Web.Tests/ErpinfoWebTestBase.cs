...
{
    public abstract class ErpinfoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ErpinfoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ErpinfoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ErpinfoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ErpinfoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ErpinfoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ErpinfoDbContext, Task<T>> func)
        {
            T result;
